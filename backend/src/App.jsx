...
const App = () => {
    ...
    if (view === 'login') return (
        <div style={{ height: '100vh', display: 'flex', justifyContent: 'center', alignItems: 'center', background: '#0a0a12' }}>
            <div style={{ background: '#161625', padding: '40px', borderRadius: '12px', border: '1px solid cyan', textAlign: 'center', width: '360px' }}>
                ...
                <p style={{ color: '#555', marginBottom: '24px', fontSize: '0.85rem' }}>v3.0 Silver – Login Required</p>
    ...
    if (view === 'dashboard_main') return (
        <div style={{ height: '100vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', background: '#0a0a12', color: 'white', gap: '20px' }}>
            ...
            <button onClick={() => { setUser(null); setView('login'); }} style={{ background: '#333', color: 'white', border: 'none', padding: '10px 20px', borderRadius: '4px', cursor: 'pointer' }}>LOGOUT</button>
        </div>
    );
        ...
        <div style={{ padding: '20px', background: '#0a0a12', color: 'white', minHeight: '100vh', fontFamily: 'sans-serif' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid #333', paddingBottom: '15px', marginBottom: '20px' }}>
                ...
                <div style={{ display: 'flex', gap: '15px', alignItems: 'center' }}>
                    ...
                    <button onClick={() => setShowChat(!showChat)} style={{ background: '#161625', color: 'cyan', border: '1px solid cyan', padding: '6px 14px', cursor: 'pointer', borderRadius: '4px' }}>💬 Chat</button>
                    <button onClick={() => { setUser(null); setView('login'); }} style={{ background: '#333', color: 'white', border: 'none', padding: '8px 15px', cursor: 'pointer', borderRadius: '4px' }}>EXIT</button>
                </div>
            </div>
